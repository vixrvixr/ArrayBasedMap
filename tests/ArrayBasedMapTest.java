...
public class ArrayBasedMapTest {
     ...
     * @throws UnsupportedOperationException if it's not possible to make a non-empty instance of
     ...
     *
     * @return a key.
     * @throws UnsupportedOperationException if it's not possible to make a key that will not be
     *                                       found in the map.
     */
     ...
     *
     * @return a value.
     * @throws UnsupportedOperationException if it's not possible to make a value that will not
     *                                       be found in the map.
     */
    ...
    protected final void assertInvariants(Map<String, Student> map) {
        ...
        final Set<Map.Entry<String, Student>> entrySet = map.entrySet();
    ...
    public void testPutNewKey() {
        ...
        if (supportsPut) {
            ...
            final Student oldValue = map.put(keyToPut, valueToPut);
